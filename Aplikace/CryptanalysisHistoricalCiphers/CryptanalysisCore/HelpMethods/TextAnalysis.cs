...
namespace CryptanalysisCore
{
    public static class TextAnalysis
    {
        ...
        /// <returns></returns>
        public static Dictionary<char, char> GetLettersSubst(Dictionary<string, string> wordPairs)
        {
        ...
        /// <returns></returns>
        public static Dictionary<char, char> GetLettersSubst(Dictionary<string, string> wordPairs, Dictionary<char, char> substitutions)
        {
            Dictionary<char, char> subsPairs = GetLettersSubst(wordPairs);
        ...
        /// <param name="pair"></param>
        /// <returns></returns>
        public static Dictionary<char, char> GetLettersSubst(string word1, string word2)
        {
            Dictionary<char, char> subst = new Dictionary<char, char>();
        ...
        /// <param name="substitutions"></param>
        /// <returns></returns>
        public static Dictionary<char, char> MergeSubstitutions(Dictionary<char, char>[] substitutions)
        {
            Dictionary<char, char> subs = new Dictionary<char, char>();
